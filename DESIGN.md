...
- Two columns: athletes, guides. In the athletes tab athletes are shown along with any guides they are paired with. In the guides tab unpaired guides are shown.
